    ...
    <Section id="pricing" crosses className="overflow-hidden">   {/*wrapper of the whole pricing section */}
        ...
        <div className="container relative z-2">
            ...
            <div className="hidden relative justify-center mb-[6.5rem] | lg:flex">                          {/*div for the sphere and the stars */}
                ...
                <img src={smallSphere} className="relative z-1" width={255} height={255} alt="sphere" loading="lazy"/>    {/*sphere image imported from assets */}
                
                <div className="absolute top-1/2 left-1/2 w-[60rem] -translate-x-1/2 -translate-y-1/2 pointer-events-none">
                    <img src={stars} className="w-full " width={950} height={400} alt="stars" loading="lazy" />                                  {/*background star image imported from assets */}
                </div>
